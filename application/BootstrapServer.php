...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    protected function _initSetupBaseUrl() {
            $this->bootstrap('frontcontroller');//istanzia e configura il bootstrap
    ...
    {
        $this->bootstrap('view');//istanzia e config la view
        $this->_view = $this->getResource('view');
        $this->_view->headMeta()->setCharset('UTF-8');
        $this->_view->headMeta()->appendHttpEquiv('Content-Language', 'it-IT');//necessario per la lingua e gli accenti
    ...
    protected function _initDefaultModuleAutoloader()
    {
        ...
        $this->getResourceLoader()
            ->addResourceType('modelResource','models/resources','Resource');//nome della risorsa, path,naming con cui identificare la risorsa
    }
    
    protected function _initActionHelpers(){//inizializza gli helper
